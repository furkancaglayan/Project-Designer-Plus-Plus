...
The shipped Asset Store version installs as a regular Unity asset inside your project and gives you a custom UI Toolkit planner, typed planning-board documents, built-in workflow presets, asset-driven reference capture, and explicit extension hooks for custom cards.
